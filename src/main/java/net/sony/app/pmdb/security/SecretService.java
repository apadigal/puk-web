...
public class SecretService {
    ...
    public void setSecrets(Map<String, String> secrets) {
        ...
        Assert.hasText(secrets.get(SignatureAlgorithm.RS384.getValue()));
        Assert.hasText(secrets.get(SignatureAlgorithm.RS512.getValue()));
    ...
    public  byte[] getRS384SecretBytes()
    {
        return TextCodec.BASE64.decode(secrets.get(SignatureAlgorithm.RS384.getValue()));
    }
    public  byte[] getRS512SecretBytes()
    {
        return TextCodec.BASE64.decode(secrets.get(SignatureAlgorithm.RS512.getValue()));
    }
